...
(
  ...
  output tlul_pkg::tl_h2d_t tl_gpio_o[GPIO_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_i[GPIO_NUM],
  ...
  xbar_main xbar (
    ...
    .tl_gpio0_o        (tl_gpio_o[0]),
    .tl_gpio0_i        (tl_gpio_i[0]),
    .tl_gpio1_o        (tl_gpio_o[1]),
    .tl_gpio1_i        (tl_gpio_i[1]),
    .tl_gpio2_o        (tl_gpio_o[2]),
    .tl_gpio2_i        (tl_gpio_i[2]),
    .tl_gpio3_o        (tl_gpio_o[3]),
    .tl_gpio3_i        (tl_gpio_i[3]),
    .tl_gpio4_o        (tl_gpio_o[4]),
    .tl_gpio4_i        (tl_gpio_i[4]),
    .tl_gpio5_o        (tl_gpio_o[5]),
    .tl_gpio5_i        (tl_gpio_i[5]),
