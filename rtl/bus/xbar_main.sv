...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_14_ds_h2d [12];
  tl_d2h_t tl_s1n_14_ds_d2h [12];
  ...
  tl_h2d_t tl_asf_16_us_h2d ;
  tl_d2h_t tl_asf_16_us_d2h ;
  tl_h2d_t tl_asf_16_ds_h2d ;
  tl_d2h_t tl_asf_16_ds_d2h ;
  ...
  assign tl_rev_tag_o = tl_s1n_14_ds_h2d[1];
  assign tl_s1n_14_ds_d2h[1] = tl_rev_tag_i;

  assign tl_gpio_o = tl_s1n_14_ds_h2d[2];
  assign tl_s1n_14_ds_d2h[2] = tl_gpio_i;

  assign tl_uart_o = tl_s1n_14_ds_h2d[3];
  assign tl_s1n_14_ds_d2h[3] = tl_uart_i;

  assign tl_timer_o = tl_s1n_14_ds_h2d[4];
  assign tl_s1n_14_ds_d2h[4] = tl_timer_i;

  assign tl_rv_plic_o = tl_s1n_14_ds_h2d[5];
  assign tl_s1n_14_ds_d2h[5] = tl_rv_plic_i;

  assign tl_pwm_o = tl_s1n_14_ds_h2d[6];
  assign tl_s1n_14_ds_d2h[6] = tl_pwm_i;
  ...
  assign tl_spi_flash_o = tl_s1n_14_ds_h2d[9];
  assign tl_s1n_14_ds_d2h[9] = tl_spi_flash_i;

  assign tl_spi_lcd_o = tl_s1n_14_ds_h2d[10];
  assign tl_s1n_14_ds_d2h[10] = tl_spi_lcd_i;

  assign tl_asf_16_us_h2d = tl_s1n_14_ds_h2d[11];
  assign tl_s1n_14_ds_d2h[11] = tl_asf_16_us_d2h;

  assign tl_sm1_15_us_h2d[1] = tl_dbg_host_i;
  assign tl_dbg_host_o = tl_sm1_15_us_d2h[1];

  assign tl_s1n_14_us_h2d = tl_ibex_lsu_i;
  assign tl_ibex_lsu_o = tl_s1n_14_us_d2h;

  assign tl_sram_o = tl_sm1_15_ds_h2d;
  assign tl_sm1_15_ds_d2h = tl_sram_i;

  assign tl_usbdev_o = tl_asf_16_ds_h2d;
  assign tl_asf_16_ds_d2h = tl_usbdev_i;
  ...
  tlul_fifo_async #(
    ...
    .clk_d_i      (clk_usb_i),
    .rst_d_ni     (rst_usb_ni),
    .tl_h_i       (tl_asf_16_us_h2d),
    .tl_h_o       (tl_asf_16_us_d2h),
    .tl_d_o       (tl_asf_16_ds_h2d),
    .tl_d_i       (tl_asf_16_ds_d2h)
  );
