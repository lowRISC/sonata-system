...
module xbar_main (
  ...
  tl_h2d_t tl_s1n_12_ds_h2d [10];
  tl_d2h_t tl_s1n_12_ds_d2h [10];
  ...
  assign tl_sm1_13_us_h2d[0] = tl_s1n_12_ds_h2d[0];
  assign tl_s1n_12_ds_d2h[0] = tl_sm1_13_us_d2h[0];

  assign tl_gpio_o = tl_s1n_12_ds_h2d[1];
  assign tl_s1n_12_ds_d2h[1] = tl_gpio_i;

  assign tl_uart_o = tl_s1n_12_ds_h2d[2];
  assign tl_s1n_12_ds_d2h[2] = tl_uart_i;

  assign tl_timer_o = tl_s1n_12_ds_h2d[3];
  assign tl_s1n_12_ds_d2h[3] = tl_timer_i;

  assign tl_rv_plic_o = tl_s1n_12_ds_h2d[4];
  assign tl_s1n_12_ds_d2h[4] = tl_rv_plic_i;

  assign tl_pwm_o = tl_s1n_12_ds_h2d[5];
  assign tl_s1n_12_ds_d2h[5] = tl_pwm_i;

  assign tl_i2c0_o = tl_s1n_12_ds_h2d[6];
  assign tl_s1n_12_ds_d2h[6] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_12_ds_h2d[7];
  assign tl_s1n_12_ds_d2h[7] = tl_i2c1_i;

  assign tl_spi_flash_o = tl_s1n_12_ds_h2d[8];
  assign tl_s1n_12_ds_d2h[8] = tl_spi_flash_i;

  assign tl_spi_lcd_o = tl_s1n_12_ds_h2d[9];
  assign tl_s1n_12_ds_d2h[9] = tl_spi_lcd_i;

  assign tl_sm1_13_us_h2d[1] = tl_dbg_host_i;
  assign tl_dbg_host_o = tl_sm1_13_us_d2h[1];

  assign tl_s1n_12_us_h2d = tl_ibex_lsu_i;
  assign tl_ibex_lsu_o = tl_s1n_12_us_d2h;

  assign tl_sram_o = tl_sm1_13_ds_h2d;
  assign tl_sm1_13_ds_d2h = tl_sram_i;
