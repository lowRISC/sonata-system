...
module xbar_main (
  ...
  assign tl_rev_tag_o = tl_s1n_24_ds_h2d[1];
  assign tl_s1n_24_ds_d2h[1] = tl_rev_tag_i;

  assign tl_gpio_o = tl_s1n_24_ds_h2d[2];
  assign tl_s1n_24_ds_d2h[2] = tl_gpio_i;

  assign tl_pwm_o = tl_s1n_24_ds_h2d[3];
  assign tl_s1n_24_ds_d2h[3] = tl_pwm_i;

  assign tl_rpi_gpio_o = tl_s1n_24_ds_h2d[4];
  assign tl_s1n_24_ds_d2h[4] = tl_rpi_gpio_i;

  assign tl_ard_gpio_o = tl_s1n_24_ds_h2d[5];
  assign tl_s1n_24_ds_d2h[5] = tl_ard_gpio_i;

  assign tl_pmod_gpio_o = tl_s1n_24_ds_h2d[6];
  assign tl_s1n_24_ds_d2h[6] = tl_pmod_gpio_i;

  assign tl_timer_o = tl_s1n_24_ds_h2d[7];
  assign tl_s1n_24_ds_d2h[7] = tl_timer_i;

  assign tl_rgbled_ctrl_o = tl_s1n_24_ds_h2d[8];
  assign tl_s1n_24_ds_d2h[8] = tl_rgbled_ctrl_i;

  assign tl_uart0_o = tl_s1n_24_ds_h2d[9];
  assign tl_s1n_24_ds_d2h[9] = tl_uart0_i;

  assign tl_uart1_o = tl_s1n_24_ds_h2d[10];
  assign tl_s1n_24_ds_d2h[10] = tl_uart1_i;

  assign tl_i2c0_o = tl_s1n_24_ds_h2d[11];
  assign tl_s1n_24_ds_d2h[11] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_24_ds_h2d[12];
  assign tl_s1n_24_ds_d2h[12] = tl_i2c1_i;

  assign tl_spi_flash_o = tl_s1n_24_ds_h2d[13];
  assign tl_s1n_24_ds_d2h[13] = tl_spi_flash_i;

  assign tl_spi_lcd_o = tl_s1n_24_ds_h2d[14];
  assign tl_s1n_24_ds_d2h[14] = tl_spi_lcd_i;

  assign tl_spi_eth_o = tl_s1n_24_ds_h2d[15];
  assign tl_s1n_24_ds_d2h[15] = tl_spi_eth_i;

  assign tl_spi_rp0_o = tl_s1n_24_ds_h2d[16];
  assign tl_s1n_24_ds_d2h[16] = tl_spi_rp0_i;

  assign tl_spi_rp1_o = tl_s1n_24_ds_h2d[17];
  assign tl_s1n_24_ds_d2h[17] = tl_spi_rp1_i;

  assign tl_spi_ard_o = tl_s1n_24_ds_h2d[18];
  assign tl_s1n_24_ds_d2h[18] = tl_spi_ard_i;

  assign tl_spi_mkr_o = tl_s1n_24_ds_h2d[19];
  assign tl_s1n_24_ds_d2h[19] = tl_spi_mkr_i;
