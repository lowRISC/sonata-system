...
// Device state
typedef enum { Device_Reset, Device_Addressed, Device_Configured } usbdev_dev_state_t;

// Control Transfer state
typedef enum { Ctrl_Setup, Ctrl_StatusSetAddr, Ctrl_StatusGetDesc, Ctrl_StatusSetConfig } usbdev_ctrl_state_t;
...
void usbdev_buf_write(usbdev_state_t *usb, uint8_t buf, const uint8_t *sp, uint8_t len);
