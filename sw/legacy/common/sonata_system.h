...
#define GPIO_OUT_EN GPIO_FROM_BASE_ADDR(GPIO_BASE + GPIO_OUT_EN_REG)

#define TIMER_IRQ (1 << 7)

#define NUM_PWM_MODULES 7
#define PWM_LCD (NUM_PWM_MODULES - 1)

#define DEFAULT_I2C I2C_FROM_BASE_ADDR(I2C0_BASE)

#define LCD_SPI SPI_FROM_BASE_ADDR(SPI0_BASE)
#define ETH_SPI SPI_FROM_BASE_ADDR(SPI1_BASE)
#define FLASH_SPI SPI_FROM_BASE_ADDR(SPI2_BASE)
#define MICROSD_SPI SPI_FROM_BASE_ADDR(SPI2_BASE)
#define RPI_SPI0 SPI_FROM_BASE_ADDR(SPI3_BASE)
#define ARDUINO_SPI SPI_FROM_BASE_ADDR(SPI3_BASE)
#define PMOD0_SPI SPI_FROM_BASE_ADDR(SPI3_BASE)
#define RPI_SPI1 SPI_FROM_BASE_ADDR(SPI4_BASE)
#define MIKRO_BUS_SPI SPI_FROM_BASE_ADDR(SPI4_BASE)
#define PMOD1_SPI SPI_FROM_BASE_ADDR(SPI4_BASE)

#define DEFAULT_USBDEV USBDEV_BASE
