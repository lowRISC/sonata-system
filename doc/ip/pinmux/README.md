...
| 0x042 | `pmod0_2` | 0, `gpio[2].ios[1]`, `spi[2].tx`, `uart[2].tx` |
| 0x043 | `pmod0_3` | 0, `gpio[2].ios[2]`, `i2c[0].scl` |
| 0x044 | `pmod0_4` | 0, `gpio[2].ios[3]`, `i2c[0].sda`, `spi[2].sck` |
