...
| 0x83c | `gpio[2].ios[16]` | 0 |
| 0x83d | `gpio[0].ios[17]` | 0, `rph_g17` |
| 0x83e | `gpio[1].ios[17]` | 0, `ah_tmpio17` |
| 0x83f | `gpio[2].ios[17]` | 0 |
| 0x840 | `gpio[0].ios[18]` | 0, `rph_g18` |
| 0x841 | `gpio[1].ios[18]` | 0 |
| 0x842 | `gpio[2].ios[18]` | 0 |
| 0x843 | `gpio[0].ios[19]` | 0, `rph_g19_cipo` |
| 0x844 | `gpio[1].ios[19]` | 0 |
| 0x845 | `gpio[2].ios[19]` | 0 |
| 0x846 | `gpio[0].ios[20]` | 0, `rph_g20_copi` |
| 0x847 | `gpio[1].ios[20]` | 0 |
| 0x848 | `gpio[2].ios[20]` | 0 |
| 0x849 | `gpio[0].ios[21]` | 0, `rph_g21_sclk` |
| 0x84a | `gpio[1].ios[21]` | 0 |
| 0x84b | `gpio[2].ios[21]` | 0 |
| 0x84c | `gpio[0].ios[22]` | 0, `rph_g22` |
| 0x84d | `gpio[1].ios[22]` | 0 |
| 0x84e | `gpio[2].ios[22]` | 0 |
| 0x84f | `gpio[0].ios[23]` | 0, `rph_g23` |
| 0x850 | `gpio[1].ios[23]` | 0 |
| 0x851 | `gpio[2].ios[23]` | 0 |
| 0x852 | `gpio[0].ios[24]` | 0, `rph_g24` |
| 0x853 | `gpio[1].ios[24]` | 0 |
| 0x854 | `gpio[2].ios[24]` | 0 |
| 0x855 | `gpio[0].ios[25]` | 0, `rph_g25` |
| 0x856 | `gpio[1].ios[25]` | 0 |
| 0x857 | `gpio[2].ios[25]` | 0 |
| 0x858 | `gpio[0].ios[26]` | 0, `rph_g26` |
| 0x859 | `gpio[1].ios[26]` | 0 |
| 0x85a | `gpio[2].ios[26]` | 0 |
| 0x85b | `gpio[0].ios[27]` | 0, `rph_g27` |
| 0x85c | `gpio[1].ios[27]` | 0 |
| 0x85d | `gpio[2].ios[27]` | 0 |
| 0x85e | `gpio[0].ios[28]` | 0 |
| 0x85f | `gpio[1].ios[28]` | 0 |
| 0x860 | `gpio[2].ios[28]` | 0 |
| 0x861 | `gpio[0].ios[29]` | 0 |
| 0x862 | `gpio[1].ios[29]` | 0 |
| 0x863 | `gpio[2].ios[29]` | 0 |
| 0x864 | `gpio[0].ios[30]` | 0 |
| 0x865 | `gpio[1].ios[30]` | 0 |
| 0x866 | `gpio[2].ios[30]` | 0 |
| 0x867 | `gpio[0].ios[31]` | 0 |
| 0x868 | `gpio[1].ios[31]` | 0 |
| 0x869 | `gpio[2].ios[31]` | 0 |
