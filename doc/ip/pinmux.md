...
| 0x02d | `ah_tmpio1` | 0, `gpio[1].ios[1]` |
...
| 0x044 | `pmod0[0]` | 0, `gpio[2].ios[0]` |
| 0x045 | `pmod0[1]` | 0, `gpio[2].ios[1]` |
| 0x046 | `pmod0[2]` | 0, `gpio[2].ios[2]` |
| 0x047 | `pmod0[3]` | 0, `gpio[2].ios[3]` |
| 0x048 | `pmod0[4]` | 0, `gpio[2].ios[4]` |
| 0x049 | `pmod0[5]` | 0, `gpio[2].ios[5]` |
| 0x04a | `pmod0[6]` | 0, `gpio[2].ios[6]` |
| 0x04b | `pmod0[7]` | 0, `gpio[2].ios[7]` |
| 0x04c | `pmod1[0]` | 0, `gpio[2].ios[8]` |
| 0x04d | `pmod1[1]` | 0, `gpio[2].ios[9]` |
| 0x04e | `pmod1[2]` | 0, `gpio[2].ios[10]` |
| 0x04f | `pmod1[3]` | 0, `gpio[2].ios[11]` |
| 0x050 | `pmod1[4]` | 0, `gpio[2].ios[12]` |
| 0x051 | `pmod1[5]` | 0, `gpio[2].ios[13]` |
| 0x052 | `pmod1[6]` | 0, `gpio[2].ios[14]` |
| 0x053 | `pmod1[7]` | 0, `gpio[2].ios[15]` |
